...
\pandocbounded{\includegraphics[keepaspectratio]{insertion-sort_files/figure-pdf/cell-2-output-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{insertion-sort_files/figure-pdf/cell-2-output-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{insertion-sort_files/figure-pdf/cell-2-output-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{insertion-sort_files/figure-pdf/cell-2-output-4.pdf}}

\begin{verbatim}
random_slope = 1.9945
sorted_slope = 1.0056
reverse_slope = 2.0001
Saved files:
images\insertion_sort_random_scaling.png
images\insertion_sort_sorted_scaling.png
images\insertion_sort_reverse_scaling.png
images\insertion_sort_raw_ops.png
\end{verbatim}
